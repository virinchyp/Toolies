...
!!
 latitude= -33.81571            %-33.780193
 longitude=151.00050           %150.905175
!!
...
IF v_cnt =0 THEN
 DIALOG.MESSAGE "No Schools In This Area", " ",go,"ok"
 IF v_error_back =1 THEN BACK.RESUME
ELSE
 IF v_error_back =1 THEN BACK.RESUME
 GOTO WaitLoop
...
ELSE
 msg2$ ="Please Select a School: "
 DIALOG.SELECT map, map$[], msg2$
 IF map = j THEN
  RETURN
 ELSEIF  map > O & map < j THEN
